...
@pytest.mark.parametrize(
    "func, args, expected_output_substr",
    [
        (
...
def test_nutrition_and_targets_inputs_invalid(
    func, args, expected_output_substr
):
...
2. Test that the function returns `False` when input string that represents 
   date in URL cannot be converted to a datetime object
"""
